...
class Echiquier:
    ...
    def obtientPiece(self, ligne, colonne):
        return self.cases_echiquier[ligne][colonne].piece
    ...
    def dessine(self, fenetre):
        ...
        affiche_message_centre(fenetre, 30, f"Coup n°{Regles.nb_coups}", (255, 255, 255), 200)
        ...
        if self.echec_en_cours is not None:
            ...
            affiche_message_centre(fenetre, 45, "Echec !", (255, 0, 0),
                                   510 if self.echec_en_cours == BLANC else 90)
